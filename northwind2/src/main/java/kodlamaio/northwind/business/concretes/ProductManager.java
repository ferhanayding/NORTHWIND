...
public class ProductManager implements ProductService {
	...
	public DataResult<Product> getByProductName(String productName) {
		...
		return new SuccessDataResult<Product>(this.productDao.getByProductName(productName),
				"başarıyla ürün isimleri listelendi");
	...
	public DataResult<List<Product>> getByProductNameOrCategory(String productName, int categoryId) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByProductNameOrCategory_CategoryId(productName, categoryId),
				"basarıyla listelendi...");
	}

	@Override
	public DataResult<List<Product>> getByCategory_CategoryIdIn(List<Integer> categories) {

		return new SuccessDataResult<List<Product>>(this.productDao.getByCategory_CategoryIdIn(categories),"basarıyla listelendi...");
	}
	...
	public DataResult<List<Product>> getAllSorted() {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(sort),"basarılı");
